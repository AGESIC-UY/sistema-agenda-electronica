...
public class PasoFinalMBean extends BaseMBean {
	...
	public String getDescripcion() {
		if (sesionMBean.getAgenda().getTextoAgenda() != null) {
			return sesionMBean.getAgenda().getTextoAgenda().getTextoTicketConf();
		}
		else {
			return null;
		}
	...
	public String imprimirTicket() {
		try {
			...
			document.addTitle("Ticket de confirmación");
